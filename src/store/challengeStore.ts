...
const initialPayments: Payment[] = [
  { id: '1', amount: 4500, date: '2024년 4월 9일', description: '커피 대신 사무실 시머를 마셨습니다.' },
  { id: '2', amount: 4500, date: '2024년 4월 9일', description: '커피 대신 사무실 시머를 마셨습니다.' },
  { id: '3', amount: 4500, date: '2024년 4월 9일', description: '커피 대신 사무실 시머를 마셨습니다.' }
];
...
export const useChallengeStore = create<ChallengeState>((set) => ({
  ...
  selectChallenge: (challengeId) => set((state) => ({
    selectedChallenge: state.challenges.find(c => c.id === challengeId) || null
  })),
  ...
  updateChallengePublic: (challengeId, isPublic) => set((state) => ({
    challenges: state.challenges.map(challenge => 
      challenge.id === challengeId ? { ...challenge, isPublic } : challenge
    ),
    selectedChallenge: state.selectedChallenge?.id === challengeId 
