  ...
  return (
    <div className="mb-3 bg-white rounded-lg p-3.5 flex justify-between items-center shadow-sm">
      <div className="flex items-center">
        <div
          className={`w-8 h-8 ${isExpense ? 'bg-red-100' : 'bg-green-100'} rounded-full flex items-center justify-center mr-3`}
        >
      ...
      <span
        className={
          isExpense ? 'text-red-500 font-medium' : 'text-green-500 font-medium'
        }
      >
